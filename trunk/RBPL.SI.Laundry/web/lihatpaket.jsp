...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
    <tr bordercolor="#666666" bgcolor="#999999">
      <th class="table-header-repeat line-left minwidth-1"><a href="">Nama Paket</a></th>
      <th class="table-header-repeat line-left minwidth-1"><a href="">Harga</a></th>
      ...
      <th class="table-header-repeat line-left minwidth-1"><a href="">DELETE</a></th>
    </tr>
    <%
      if (rs != null){
         while(rs.next()){
