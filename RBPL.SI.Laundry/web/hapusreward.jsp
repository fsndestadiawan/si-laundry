...
<div id="content">
	...
	<div id="page-heading">
		<h1>
		 Apakah Data Reward Akan Dihapus?		</h1>
	</div>
	<!-- end page-heading -->
  ...
  String reward = request.getParameter("ed_reward");

%>
<form name="form1" method="post" action="proseshapusreward.jsp">
  <table width="56%" border="1">

    <tr>
      <td width="22%">Jumlah Reward</td>
            <td><input name="reward" type="text" readonly value="<%=reward%>" size="50"/></td>
    </tr>
    <tr>
