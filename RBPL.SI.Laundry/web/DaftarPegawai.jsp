...
<div class="body" id="main">
  ...
  <div id="menu">
    <div align="center">
      <p><a href="daftarPegawai.jsp"><span class="style6">Home</span></a> <span class="style7">
      <hr />
      <br />
    </div>
  </div>
  ...
  <div id="konten">
    <FORM METHOD=POST ACTION="CreatePegawai.jsp">
        <p>Register User Pegawai</p>
        <table width="327" border="0">
          <tr>
            <td width="98">NIP*</td>
            <td width="219">:
            <input name="nip" type="text"  />   </td>
          </tr>
          <tr>
            <td>Password*</td>
            <td>:
    ...
    if (b != null){
    out.println("Nip dan Password harus 6 karakter.");
    }
