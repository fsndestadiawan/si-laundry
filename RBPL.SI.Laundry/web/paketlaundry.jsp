...
<div id="content">
	...
	<tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%">
          <tr>
            <th valign="top">Nama Paket*</th>
            <th valign="top">:
            <input name="namapaket" type="varchar"  />   </th>
          </tr>
          <tr>
            <th valign="top">Harga*</th>
            <th valign="top">:
            <input name="harga" type="varchar"  /></th>
          </tr>
          <tr>
            <th valign="top">Keterangan*</th>
            <th valign="top">:
            <input name="keterangan" type="varchar" /></th>
          </tr>
          <tr>
            <td colspan="2"><div align="center">
              <input type="submit" name="submit" value="Submit"  class="form-submit" />
              <input type="reset" name="submit2" value="Reset" class="form-reset" />
            </div></td>
          </tr>
      </table>
        <%
