...
<div class="nav-outer">
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li  ><a href="lihatorderlist.jsp">View Order</a></li>
			</ul>
		</div>
		</li>
		</ul>
...
<div id="content">
  ...
  String kueri = "SELECT * FROM order_baru";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
    <tr bordercolor="#666666" bgcolor="#999999">
      <th class="table-header-repeat line-left minwidth-1"><a href="">Paket Order</a></th>
      <th class="table-header-repeat line-left minwidth-1"><a href="">Waktu Ambil</a></th>
      <th class="table-header-repeat line-left minwidth-1"><a href="">Alamat Ambil</a></th>
      
    </tr>
    <%
      if (rs != null){
         while(rs.next()){
            String paketorder = rs.getString(2);
            String waktuambil = rs.getString(3);
            String alamatambil = rs.getString(4);
     %>
         <tr>
      <td><%=paketorder%></td>
      <td><%=waktuambil%></td>
